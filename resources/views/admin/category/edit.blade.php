                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <img src="{{ asset('/uploads/category/' . $category->image) }}" width="100px"
                                    class="border" alt="resim-bulunamadı">
                                @error('image')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="metaKeyword" class="form-control" rows="3">{{ $category->metaKeyword }}</textarea>
                                @error('metaKeyword')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="metaDescription" class="form-control" rows="3">{{ $category->metaDescription }}</textarea>
